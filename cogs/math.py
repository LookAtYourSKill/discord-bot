...
class Math(commands.Cog):
    ...
    async def _addition(self, ctx, first: int, second: int):
        result = first + second
    ...
    async def _subtraction(self, ctx, first: int, second: int):
        result = first - second
    ...
    async def _multiplication(self, ctx, first: int, second: int):
        result = first * second
    ...
    async def _dividation(self, ctx, first: int, second: int):
        result = first / second
